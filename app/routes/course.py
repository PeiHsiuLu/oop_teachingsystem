...
def add_course_words_to_review_queue(user, unit):
    """
    Scan the course unit content and add matched vocabulary words
    to the user's review queue.

    If a word appears in the course content, it will be added to ReviewItem.
    """
...
def view_unit(unit_id):
    ...
    # Do not automatically add course words to vocabulary review.
    # Only words completed in sentence practice should enter the review list.
    # add_course_words_to_review_queue(current_user, unit)
